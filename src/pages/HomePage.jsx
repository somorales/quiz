...
export default function HomePage() {
  return (
    <div>
      ...
      <div  className="bg-[#FFC95F] rounded-3xl shadow-lg  shadow-[#065471] max-w-2xl p-32 space-y-8 border-1 border-[#065471]" >
        <div className="space-y-6 text-center " >
            ...
            <div className="my-10 flex flex-col items-center justify-center gap-2">
              <Link
                to="/game"
                className="bg-[#065471] border-2 border-[#FFC045] rounded-3xl hover:bg-[#FFC045] hover:border-black hover:text-black   px-3.5 py-2.5 shadow-sm w-80 font-bold text-white text-center"
              >
                Get Start
              </Link>
            </div>
